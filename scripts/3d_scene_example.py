...
def add_3d_scene():
    scene_path = 'scene/Главный стол+ПК.obj'
...
def setup_args():
    ...
    parser.add_argument('--recompute_norms', type=bool, default=True,
                        help='Recompute norms.')
    parser.add_argument('--edge_split', type=bool, default=True,
                        help='Adds edge split filter.')
    parser.add_argument('--depth_scale', type=float, default=1.4,
                        help='''Scaling that is applied to depth. \
                                Depends on size of mesh. Try out various values until you get a good result. \
